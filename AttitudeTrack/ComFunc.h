#ifndef __COMFUNC_H__
#define __COMFUNC_H__
#include <math.h>
#include <string>
#include <stdlib.h>
#include <stdio.h>
...
/*************************log******************************/ 
extern void fopendhf(const char *file); //路径
...
/* -----------by dhf,2017.08.11----------*/
extern void lever_compen(double blh_ant[3], double lever_ned[3], double blh_target[3], int option = 0);
